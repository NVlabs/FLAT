...
if __name__ == '__main__':
    ...
    file_name = 'tof_net_open_kinect_batch'
    from training_open_kinect import tof_net_func
    ...
    Sanity check
    """
    f_trains = open(goal_dir+'list/scenes-train.txt','r')
    f_vals = open(goal_dir+'list/scenes-val.txt','r')
    f_tests = open(goal_dir+'list/scenes-test.txt','r')
